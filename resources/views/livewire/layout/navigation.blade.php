...
<aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <img class="w-3/4 h-auto mx-auto my-6" src="{{ asset('images/2560px-Bank_BTN_logo.svg.png') }}" alt="Logo">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button wire:click="logout"
                    ...
                    <svg fill="currentColor"version="1.1" id="Capa_1" class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 384.971 384.971" xml:space="preserve" stroke="currentColor" stroke-width="17.323695">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap text-start">{{ __('Keluar') }}</span>
                </button>
            </li>
        </ul>
    </div>
